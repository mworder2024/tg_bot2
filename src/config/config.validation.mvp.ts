...
export const configValidation = Joi.object({
  ...
  DB_DATABASE: Joi.string().default("./data/gamebot.db"),
  ...
  // Game Configuration
  GAME_ROUND_TIMEOUT: Joi.number().integer().min(10).max(300).default(30),

  MAX_GAME_ROUNDS: Joi.number().integer().valid(3, 5, 7).default(3),

  GAME_MOVE_TIMEOUT: Joi.number().integer().min(5).max(120).default(30),
